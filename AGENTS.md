...
This project is indexed by GitNexus as **zsh-plugin-ah** (16 symbols, 0 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/zsh-plugin-ah/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/zsh-plugin-ah/context` | Codebase overview, check index freshness |
| `gitnexus://repo/zsh-plugin-ah/clusters` | All functional areas |
| `gitnexus://repo/zsh-plugin-ah/processes` | All execution flows |
| `gitnexus://repo/zsh-plugin-ah/process/{name}` | Step-by-step execution trace |
